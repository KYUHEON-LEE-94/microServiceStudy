# PowerShell 스크립트를 사용하여 Docker 컨테이너 실행

# Zipkin 컨테이너 실행
Write-Output "Starting Zipkin container..."
docker run -d --name zipkinCon -p 9411:9411 openzipkin/zipkin

# keycloak
Write-Output "Starting Keycloak container..."
...
Write-Output "Starting MySQL container for order-service..."
...
Write-Output "Starting MySQL container2 for inventory-service..."
